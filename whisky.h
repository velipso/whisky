...
// HASH FUNCTIONS
//
// Note: the primary and alternates pass all dieharder tests and are of equal quality
//
...
static uint32_t whisky4alt2(uint32_t i0, uint32_t i1, uint32_t i2, uint32_t i3){
