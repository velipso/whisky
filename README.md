...
The `whisky2alt` hash function also takes two arguments, and is equal quality compared to `whisky2`
...
|     5     |            120,000 |         478,771 | `e 5 22 19801` | `b 5 22 16247`<br/>`a 5 22 2845` |
